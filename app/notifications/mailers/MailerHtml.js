    ...
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          ...
          <div class="email-row-container" style="padding: 10px;background-color: #f0f0f0">
            <div
                ...
                <div class="email-col email-col-100"
                  ...
                  <div style="width: 100% !important;">
                    ...
                    <div
                      ...
                      <table id="u_content_image_1" class="u_content_image" style="font-family:'Lato',sans-serif;"
          ...
          <div class="email-row-container" style="padding: 18px 10px;background-color: rgba(255,255,255,0)">
            <div
              style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;"
              class="email-row">
              <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                ...
                <div class="email-col email-col-100"
                  ...
                  <div style="width: 100% !important;">
                    ...
                    <div
                      ...
                      <table id="u_content_text_9" class="u_content_text" style="font-family:'Lato',sans-serif;"
                        role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td
                ...
                <div class="email-col email-col-100"
                  ...
                  <div style="width: 100% !important;">
                    ...
                    <div
                      ...
                      <table id="u_content_text_10" class="u_content_text" style="font-family:'Lato',sans-serif;"
                        role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div style="color: #000; line-height: 120%; text-align: center; word-wrap: break-word;">
                                <div style="font-family: arial, helvetica, sans-serif;"><span
                                    style="font-size: 12px; color: #999999; line-height: 14.4px;">Please follow us on
                                    any of these social media platforms.</span></div>
